...
const AddMemberPage = lazy(() => import('./components/AddMemberPage'));
const TasksPage     = lazy(() => import('./components/TasksPage'));
const AssignTaskPage = lazy(() => import('./components/AssignTaskPage'));
...
function PageLoader() {
  return (
    <div style={{
      ...
      height: '50vh', gap: '0.75rem', color: 'var(--text-secondary)',
